...
use gpui::{
    AnyElement, App, DefiniteLength, Entity, InteractiveElement as _, IntoElement, MouseButton,
    ParentElement as _, Rems, RenderOnce, Styled as _, Window, div, px, relative,
};
...
use crate::{focus, ActiveTheme, Icon};
        ...
        div()
                ...
                div()
                    ...
                    .when(!state.disabled, |this| {
                        this.on_action(window.listener_for(&self.state, InputState::backspace))
                            ...
                            .on_action(
                                window.listener_for(&self.state, InputState::delete_next_word),
                            )
                    ...
                    .on_action(
                        window.listener_for(&self.state, InputState::select_to_start_of_line),
                    )
                    .on_action(window.listener_for(&self.state, InputState::select_to_end_of_line))
                    .on_action(
                        window.listener_for(&self.state, InputState::select_to_previous_word),
                    )
                    ...
                    .child(
                        h_flex()
                            ...
                            .when_some(
                                ...
                                |this, clear_btn| this.child(clear_btn),
                            )
                            .children(suffix),
                    )
                    .when(state.is_multi_line(), |this| {
            ...
            .child(
                div()
                    ...
                    .child(
                        Button::new("Submit").icon(Icon::default().path("assets/icons/arrow-up.svg"))
                    )
            )
    }
}
